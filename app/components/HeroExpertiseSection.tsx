...
export default function HeroWithValuesSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-20 right-4 sm:right-10 w-40 h-40 md:w-80 md:h-80 bg-purple-500/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-center">
          ...
          >
            ...
            <div
              className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 backdrop-blur-xl mb-3 md:mb-4
    max-[720px]:flex max-[720px]:mx-auto max-[720px]:justify-center max-[720px]:block"
            >
            ...
            <p className="text-sm sm:text-base md:text-lg text-slate-300 mb-4 md:mb-6 leading-relaxed">
              ...
              <span className="text-pink-400 font-semibold">IA</span>. Je
              transforme vos idées en solutions digitales innovantes et
              performantes.
            </p>
