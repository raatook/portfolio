        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-center">
          ...
          <div className="mb-4 md:mb-6 flex justify-center lg:justify-start">
              <div className="relative group">
                ...
                <img src="/logo.svg" alt="RTdev Logo" className="w-16 h-16 sm:w-20 sm:h-20 relative animate-float"  />
              </div>
            </div>
              ...
              {statsData.map((stat, idx) => (
                <div key={idx} className="bg-white/5 backdrop-blur-xl rounded-lg p-2 md:p-3 border border-white/10">
                  ...
                  <div className="text-slate-400 text-xs font-medium">
                    {t(stat.labelKey)} {/* ✅ Traduit dynamiquement */}
                  </div>
                </div>
              ))}
            </div>
              ...
              >
                <div className="relative h-full bg-white/5 backdrop-blur-xl rounded-xl p-3 md:p-4 border border-white/10 hover:border-white/20 overflow-hidden">
                  ...
                  <div className="relative">
                    <div className={`w-8 h-8 md:w-10 md:h-10 rounded-lg bg-gradient-to-br ${value.color} flex items-center justify-center mb-2 md:mb-3 transition-transform duration-700 group-hover:scale-125 group-hover:rotate-12 shadow-lg animate-fade-in-up`}>
                    ...
                    <h3 className="text-xs md:text-sm font-bold text-white mb-1 group-hover:text-indigo-200 transition-colors animate-fade-in-up delay-100">
                      {t(`hero.values.${value.key}.title`)} {/* ✅ Traduit */}
                    </h3>
                    ...
                    <p className="text-slate-400 text-xs leading-relaxed group-hover:text-slate-300 transition-colors animate-fade-in-up delay-200">
                      {t(`hero.values.${value.key}.description`)} {/* ✅ Traduit */}
                    </p>
                  </div>
